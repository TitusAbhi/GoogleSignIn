package com.titus.synccontacts;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_GET_AUTH_CODE) {
            ...
            if (result.isSuccess()) {
                ...
                Log.d(TAG, "onActivityResult:GET_AUTH_CODE:" + authCode);

                // Show signed-in UI.
                mAuthCodeTextView.setText(acct.getDisplayName());
                updateUI(true);
    ...
    private void updateUI(boolean signedIn) {
        if (signedIn) {
            ((TextView) findViewById(R.id.status)).setText(R.string.signed_in_fmt);
